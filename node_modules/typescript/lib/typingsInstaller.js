...
(function (ts) {
    ...
    ts.version = ts.versionMajorMinor + ".0-dev.20170801";
})(ts || (ts = {}));
(function (ts) {
...
(function (ts) {
    ...
    (function (Parser) {
        ...
        function parseParenthesizedArrowFunctionExpressionHead(allowAmbiguity) {
            ...
            var isAsync = (ts.getModifierFlags(node) & 256) ? 2 : 0;
    ...
    function parseJsonConfigFileContentWorker(json, sourceFile, host, basePath, existingOptions, configFileName, resolutionStack, extraFileExtensions) {
        ...
        function getFileNames() {
            ...
            if (ts.hasProperty(raw, "exclude")) {
                ...
                var specs = includeSpecs ? [] : ["node_modules", "bower_components", "jspm_packages"];
